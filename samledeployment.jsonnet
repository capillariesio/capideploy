...
// Helper
  ...
  // Artifacts (all paths are absolute)
  local capillariesRoot = '/mnt/c/Users/John Doe/src/capillaries',
  local buildLinuxAmd64Dir = capillariesRoot + '/build/linux/amd64',
  local buildLinuxArm64Dir = capillariesRoot + '/build/linux/arm64',
  local buildLinuxDir =
  ...
  file_groups_up: {
    ...
    up_ui: {
      src: capillariesRoot + '/ui/build/all.tgz',
